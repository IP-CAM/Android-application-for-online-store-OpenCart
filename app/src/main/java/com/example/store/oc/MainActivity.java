...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new OcMain(MainActivity.this, main_linear_products).execute();


    }
    public class OcMain extends AsyncTask<String, Void, String> {
        private Context context;
        LinearLayout main_linear_products;
        Gson gson;


        public OcMain(Context context, LinearLayout main_linear_products) {
        ...
        protected String doInBackground(String... arg0) {
            try {
                ...
                String link = getString(R.string.domain) + "index.php?route=appapi/products";
        ...
        protected void onPostExecute(String result) {
            ...
            for (int i=0; i<products.length; i++){
                ...
                txt.setText(Html.fromHtml(products[i].getName())); // Html.fromHtml дозволить уникнути закодовані символи
